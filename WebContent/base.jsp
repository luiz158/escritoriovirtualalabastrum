...
<html lang="pt-br">
	...
	<noscript>
	 ...
	 <body data-spy="scroll" data-target=".subnav" data-offset="50" style="position: relative;">
		...
		<p class="bem-vindo" > ${sessaoUsuario.usuario.vNome}, bem vindo(a) ao seu escrit�rio virtual!  </p>

 		<div class="menu" data-collapse="persist">

	      	<h3 class="menu-accordion" > MEUS DADOS </h3>
	        <div>
	        	<a href="<c:url value="/home/home"/>" class="submenu-accordion" > P�gina inicial </a>
	        ...
	        <div>
	        	...
	        	<a href="<c:url value="/pontuacao/acessarTelaPontuacao"/>" class="submenu-accordion" > Pontua��o </a>
	        	<a href="<c:url value="/pontuacaoAnual/acessarTelaPontuacaoAnual"/>" class="submenu-accordion" > Pontua��o anual</a>
	        	<a href="<c:url value="/arvoreRelacionamento/acessarTelaArvoreRelacionamento"/>" class="submenu-accordion" > �rvore de relacionamentos </a>
	        ...
	        <div>
	        	...
	        	<a href="<c:url value="/transferenciaCredito/acessarTelaTransferenciaCredito"/>" class="submenu-accordion" > Transfer�ncia de cr�dito </a>
	        </div>
	         <h3 class="menu-accordion" > BONIFICA��O </h3>
	        <div>
	        ...
	        <div>
	        	...
	        	<a href="<c:url value="/home/qualificacao"/>" class="submenu-accordion" > Qualifica��o </a>
	        	<a href="<c:url value="/centroDistribuicao/listarCentrosDistribuicao"/>" class="submenu-accordion" > Centros de distribui��o </a>
	        	<a href="<c:url value="/linhaAscendente/exibirLinhaAscendente"/>" class="submenu-accordion" > Linha Ascendente </a>
	        	<a href="<c:url value="/dataQualificacoes/acessarTelaDataQualificacoes"/>" class="submenu-accordion" > Datas de qualifica��es </a>
	        </div>
	        <h3 class="menu-accordion" > INFORMA��ES �TEIS </h3>
	        <div>
	        ...
	        <c:if test="${sessaoUsuario.usuario.informacoesFixasUsuario.administrador}">
		        ...
		        <div>
		        	...
		        	<a href="<c:url value="/bonificacaoRede/acessarBonificacaoRede"/>" class="submenu-accordion" > Bonifica��o dos ativos </a>
		        	<a href="<c:url value="/enviadorEmails/acessarEnviadorEmails"/>" class="submenu-accordion" > Enviar emails para a rede </a>
		        	<a href="<c:url value="/configuracao/configuracoes"/>" class="submenu-accordion" > Configura��es </a>
